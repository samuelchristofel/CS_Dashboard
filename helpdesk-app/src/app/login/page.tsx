      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-lg shadow-soft p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button type="submit" disabled={isLoading} className="w-full bg-[#EB4C36] hover:bg-[#d13a25] text-white font-bold py-3 px-4 rounded-xl transition-colors shadow-lg shadow-[#EB4C36]/30 disabled:opacity-50">
        ...
        {/* Footer */}
        <p className="text-center text-sm text-slate-400 mt-6">© 2024 Vastel Indonesia. All rights reserved.</p>
      </div>
    </div>
  );
}
