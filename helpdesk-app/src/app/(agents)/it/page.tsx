                                ...
                                <div className="px-6 py-4 border-b border-slate-50 flex items-center justify-between flex-shrink-0">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className={`inline-flex items-center px-2 py-0.5 rounded-md text-[10px] font-bold uppercase ${selectedTicket.priority === 'HIGH' ? 'bg-red-50 text-red-600' :
                                            ...
                                            {!selectedTicket.priority.startsWith('!') ? selectedTicket.priority === 'HIGH' ? '! ' : '' : ''}{selectedTicket.priority}
                                        </span>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative pl-4 space-y-6 before:absolute before:left-[5px] before:top-2 before:bottom-2 before:w-0.5 before:bg-slate-100">
                                                        ...
                                                        <div className="bg-slate-50 p-3 rounded-xl">
                                                            <div className="flex items-center gap-2">
                                                                <p className="text-sm font-bold text-slate-900">
                                                                    {activity.user?.name ? `${activity.user.name}: ` : ''}{activity.action.replace(/_/g, ' ')}
                                                                </p>
                                                            </div>
                                            ...
                                            {ticketActivities.length === 0 && (
                                                <p className="text-sm text-center text-slate-400">No activity history.</p>
                                            )}
                                        </div>
                                    </div>
                                </div>
