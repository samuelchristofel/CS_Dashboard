...
export default function NotesPanel({
    ...
    const handleToggleCheckItem = async (itemId: string) => {
        ...
        const updatedItems = parsed.checklist_items.map(item =>
        ...
        setNotes(prevNotes => prevNotes.map(note =>
            note.id === currentNote.id ? { ...note, content: updatedContent } : note
        ));
    ...
    if (!ticketId) {
        return (
            <div className="flex-1 bg-white rounded-[2rem] shadow-soft flex flex-col items-center justify-center p-8 text-center">
    ...
    return (
        <div className="flex-1 bg-white rounded-[2rem] shadow-soft flex flex-col overflow-hidden">
            {/* Header */}
                ...
                {isLoading ? (
                    ...
                    <div className="flex-1 flex flex-col gap-4">
                        ...
                        <div className="flex gap-2 pt-2">
                            ...
                            <button
                                ...
                                className="flex-1 py-3 text-white font-bold rounded-xl shadow-lg transition-all hover:opacity-90 disabled:opacity-50"
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center text-center">
                        ...
                        <button
                            ...
                            className="px-4 py-2 text-sm font-bold rounded-xl text-white shadow-lg transition-transform hover:scale-105"
                            style={{ backgroundColor: accentColor }}
                        >
                            Add your first note
                        </button>
                            ...
                            {(() => {
                                ...
                                return (
                                    <>
                                        ...
                                        {/* Note Content */}
                                        {parsed.content && (
                                            <p className="text-sm text-slate-600 mb-4 leading-relaxed">{parsed.content}</p>
                                        )}
                                        ...
                                        {parsed.checklist_items.length > 0 && (
                                            <div className="space-y-2 mb-4 pt-3 border-t border-slate-100">
                                                {parsed.checklist_items.map((item) => (
                                                    ...
                                                    >
                                                        <div
                                                            className={`size-5 rounded flex items-center justify-center transition-colors ${item.checked
                                                                ? 'bg-green-500'
